import { Node, PropertyAccessExpression } from "ts-simple-ast";
/**
 ...
 */
export declare function propertyAccessWithObjFilter(objIdentifier: string): (node: Node<import("../../../../../../Users/gjacobs/dev/js-to-ts-converter/node_modules/ts-simple-ast/dist/typescript/typescript").ts.Node>) => node is PropertyAccessExpression<import("../../../../../../Users/gjacobs/dev/js-to-ts-converter/node_modules/ts-simple-ast/dist/typescript/typescript").ts.PropertyAccessExpression>;
