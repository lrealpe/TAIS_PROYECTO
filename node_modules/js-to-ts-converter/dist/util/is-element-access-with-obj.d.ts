import { ElementAccessExpression, Node } from "ts-simple-ast";
/**
 ...
 */
export declare function elementAccessWithObjFilter(objIdentifier: string): (node: Node<import("../../../../../../Users/gjacobs/dev/js-to-ts-converter/node_modules/ts-simple-ast/dist/typescript/typescript").ts.Node>) => node is ElementAccessExpression<import("../../../../../../Users/gjacobs/dev/js-to-ts-converter/node_modules/ts-simple-ast/dist/typescript/typescript").ts.ElementAccessExpression>;
